    ...
    public class AppConfigDbContext(DbContextOptions<AppConfigDbContext> options) : DbContext(options)
    {
        ...
        private static void PouplateParametroCategoria(ModelBuilder modelBuilder)
        {
            ...
            [
                ...
                new(2, "Curso Aprobado", "", null, null, null, null, null, null, null, null, null),
                new(4, "Tipo Impedimento", "", null, null, null, null, null, null, null, null, null),
                new(5, "Tipo Nombramiento", "", null, null, null, null, null, null, null, null, null),
                new(6, "Pueblos", "Def Pueblos con Dos Niveles de Filtros", "Estado", "Pais", null, null, null, null, null, null, null),
                new(7, "Categoria Licencias", "", null, null, null, null, null, null, null, null, null),
                new(8, "Firmas", "", "Posición / Puesto", null, null, null, null, null, null, null, null),
                new(9, "Acciones", "", null, null, null, null, null, null, null, null, null),
                new(10, "Genero", "", null, null, null, null, null, null, null, null, null),
                new(11, "Region", "", null, null, null, null, null, null, null, null, null),
                new(12, "Tipo Convocatoria", "", null, null, null, null, null, null, null, null, null),
                new(13, "Dependencias", "", null, null, null, null, null, null, null, null, null),
                ...
                new(37, "AsignacionLocalización", "", "Oficina / Local", "Num Local", "Num Region", null, null, null, null, null, null),
                ...
                new(40, "TipoAgencia", "Tipos de Agencias ConfAgencias", null, null, null, null, null, null, null, null, null),
                new(41, "LugarEntrevista", "Lugar de la Entrevista para Formulario de Entrevista Inicial", null, null, null, null, null, null, null, null, null),
                new(42, "AntecedentesDependencias", "Dependencia", "Programa", null, null, null, null, null, null, null, null),
                new(43, "GrupoBeneficio", "Estudio Inicial Grupo Beneficios", null, null, null, null, null, null, null, null, null),
                new(44, "GrupoCategoria", "Tipos de Agencias ConfAgencias", null, null, null, null, null, null, null, null, null),
                new(45, "RecomendacionEstudio", "Recoomendaciones del Estudio Iniicial", null, null, null, null, null, null, null, null, null),
                new(46, "PlandeSalud", "Plan", null, null, null, null, null, null, null, null, null),
                new(47, "TipoPlanSalud", "TipoPlanSalud", null, null, null, null, null, null, null, null, null),
                new(48, "PlanMedico", "PlanMedico", null, null, null, null, null, null, null, null, null),
                new(49, "Locales", "Recoomendaciones del Estudio Iniicial", null, null, null, null, null, null, null, null, null),
                new(51, "EstadoEmpleo", "Para Referidos", null, null, null, null, null, null, null, null, null),
            ];
            ...
            [
                ...
                new(31, "Refiere Adulto", "Persona que realiza Llamada o Refiere", "Refiere", null, null),
                ...
                new(37, "Aguadilla", string.Empty, "Aguadilla I", "0301", "03"),
                new(37, "Arecibo", string.Empty, "Arecibo I", "0701", "07"),
                new(37, "Bayamon", string.Empty, "Bayamon I", "1101", "11"),
                new(37, "Caguas", string.Empty, "Caguas I", "1301", "13"),
                new(37, "Carolina", string.Empty, "Carolina I", "1601", "16"),
                new(37, "Guayama", string.Empty, "Guayama", "3101", "31"),
                new(37, "Humacao", string.Empty, "HUmacao", "3701", "37"),
                new(37, "Mayaguez", string.Empty, "Mayaguez I", "5101", "51"),
                new(37, "Ponce", string.Empty, "Ponce I", "5901", "59"),
                new(37, "San Juan", string.Empty, "San Juan I", "6701", "67"),
                new(37, "San Juan", string.Empty, "Guaynabo I", "3301", "67"),
                new(37, "Aguadilla", string.Empty, "Isabela", "3801", "03"),
                new(37, "Aguadilla", string.Empty, "Moca", "5201", "03"),
                new(37, "Aguadilla", string.Empty, "San Sebastian", "7001", "03"),
                ...
                new(37, "Aguadilla", string.Empty, "Aguada", "0201", "03"),
                new(37, "Aguadilla", string.Empty, "Aguadilla II", "0302", "03"),
                new(37, "Aguadilla", string.Empty, "Las Marias", "4401", "03"),
                new(37, "Aguadilla", string.Empty, "Rincon", "6101", "03"),
                new(37, "Arecibo", string.Empty, "Arecibo III", "0703", "07"),
                new(37, "Arecibo", string.Empty, "Barcloneta", "0901", "07"),
                new(37, "Arecibo", string.Empty, "Camuy", "1401", "07"),
                new(51, "Empleado", null, null, null, null),
                new(51, "Desempleado", null, null, null, null),
            ];
